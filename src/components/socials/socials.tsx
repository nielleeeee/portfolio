...
export default function Socials() {
  return (
    <div className="flex justify-center items-center w-max bg-white shadow-[0px_0px_15px_#00000027] px-6 py-3 md:px-8 md:py-4 rounded-[5em]">
      ...
      >
        <label className="sr-only">Nielle github profile</label>
      ...
      >
        <label className="sr-only">Nielle linkedin profile</label>
      ...
      >
        <label className="sr-only">Nielle facebook profile</label>
    ...
    c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z"
      ...
      >
        <label className="sr-only">Nielle instagram profile</label>
      ...
      >
        <label className="sr-only">Nielle resume download</label>
